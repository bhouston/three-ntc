...
import {
  createMaterialXCompileRegistry,
  compileNodeFromRegistry,
...
class MaterialXNode {
  ...
  getTexture(): any {
    ...
    materialX.textureLoadPromises.push(
...
class MaterialXDocument {
  ...
  parse(
    ...
    options: { interfaceValidator?: (rootNode: MaterialXNode, log: MaterialXLog) => void } = {},
