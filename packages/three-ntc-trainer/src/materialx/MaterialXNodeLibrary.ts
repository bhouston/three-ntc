...
const mx_normalmap = (
  ...
  const safeValue = dot(mapValue, mapValue)
    .equal(0)
    .mix(decoded, vec3(0.0, 0.0, 1.0));
...
const mx_worley_noise_materialx_3d = (position: any, jitter: any, style: any, nodeX: any) =>
  usesVec3Noise(nodeX)
    ...
    : usesVec2Noise(nodeX)
      ? mx_worley_noise_vec2_style(position, jitter, style)
...
const MXElements: MXElement[] = [
  ...
  createMXElement(
    'fractal3d',
    mx_fractal_noise_materialx_3d,
    ['position', 'octaves', 'lacunarity', 'diminish', 'amplitude'],
    {
      position: () => positionLocal,
      octaves: defaultInt(3),
      lacunarity: defaultFloat(2.0),
  ...
  createMXElement(
    'worleynoise2d',
    mx_worley_noise_materialx_2d,
    ['texcoord', 'jitter', 'style'],
    {
      texcoord: defaultVec2(0, 0),
  ...
  createMXElement(
    'worleynoise3d',
    mx_worley_noise_materialx_3d,
    ['position', 'jitter', 'style'],
    {
      position: () => positionLocal,
      jitter: defaultFloat(1),
      style: defaultInt(0),
