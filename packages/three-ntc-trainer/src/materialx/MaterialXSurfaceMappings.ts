...
function warnIgnoredInputs( inputs: Record<string, any>, mappedInputs: Set<string>, log: MaterialXLog, surfaceCategory: string, nodeName: string ): void {
...
function setTransmissionFlags( material: any, transmissionNode: any, opacityNode: any, allowOpacityTransparency = true ): void {
...
function getSurfaceMapper( category: string ) {
