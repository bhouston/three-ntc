...
export const MATERIALX_SAMPLES: MaterialXSample[] = [
  ...
  },
  {
    ...
    description:
      'MaterialX conformance test chaining rotate2d then a non-uniform scale before sampling - the opposite node order from scale_rotate2d_test.mtlx.',
  },
  {
  ...
  },
  {
    ...
    description:
      'MaterialX conformance test chaining a non-uniform scale then rotate2d before sampling - the opposite node order from rotate_scale2d_test.mtlx.',
  },
  {
 ...
 */
export function populateMaterialXSelect(
